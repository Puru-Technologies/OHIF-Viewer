...
modes.push("@ohif/mode-puru-quick");
modes.push("@ohif/mode-puru-report");
...
async function loadModule(module) {
  ...
  if( module==="@ohif/extension-puru-reports") {
    const imported = await import("@ohif/extension-puru-reports");
    return imported.default;
  }
  ...
  if( module==="@ohif/mode-puru-quick") {
    const imported = await import("@ohif/mode-puru-quick");
    return imported.default;
  }
  if( module==="@ohif/mode-puru-report") {
    const imported = await import("@ohif/mode-puru-report");
    return imported.default;
  }
